<?php 
  ...
  foreach ($conex->consultar($query) as $key => $value) {
    ...
    //Llenar columna PUNTUACIÓNid_opcion_pregunta
...
//Llenar columna TotalCriticas
  ...
  echo '
    ...
    <div class="text-center col-md-12">
      <a href="reporteConteoView.php">
        <button class="btn btn-success"><i class="fa fa-clipboard" aria-hidden="true"></i> Ver Reporte Conteo
        </button>
      </a>
    </div>
  ';
